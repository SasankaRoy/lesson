...
export const Qutos = () => {
  return (
    <>
      <section class="text-gray-300 body-font bg-[#320101]">
        <div class="container px-5 py-24 mx-auto">
          <div class="lg:w-2/3 flex flex-col sm:flex-row sm:items-center sm:justify-between items-start mx-auto">
            ...
            <h1 class="flex-grow sm:pl-16 text-2xl font-medium title-font ">
